...
from asciimatics.widgets import Frame, Layout, FileBrowser, Widget, Label, PopUpDialog, Text, Divider, VerticalDivider
...
class DemoFrame(Frame):
    def __init__(self, screen):
        ...
        layout.add_widget(Label("Logstash Debug"))
...
webserver = threading.Thread(target=debugserver.start, args=(queue,))
